...
⚠️ **Em Desenvolvimento:** Este projeto ainda está em fase de construção.
...
- `GET /locadora/clientes/{idCliente}`: Retorna os detalhes de um cliente em específico.
- `POST /locadora/clientes`: Adiciona um novo cliente.

### Filmes

- `GET /locadora/filmes`: Retorna a lista de todos os filmes.
- `GET /locadora/filmes/{idFilme}`: Retorna os detalhes de um filme em específico.
- `POST /locadora/clientes`: Adiciona um novo filme.

### Reserva filme

- `GET /locadora/reservafilme`: Retorna a lista de todos as reservas de filmes, incluindo o cliente e o filme.
- `GET /locadora/reservafilme/{idReserva}`: Retorna os detalhes de uma reserva em específico.
- `POST /locadora/reservafilme`: Adiciona uma nova reserva de filme, para um cliente.
- `PATCH /locadora/reservafilme/{idReserva}`: Finaliza uma reserva de filme existente.
